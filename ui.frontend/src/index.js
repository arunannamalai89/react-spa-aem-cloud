...
class ModelClientWrapper extends ModelClient {
  constructor() {
    super();
    this._apiHost = process.env.REACT_APP_API_HOST;
    this._isExternalApi = true;
  }
}

const modelManagerOptions = {};
modelManagerOptions.modelClient = new ModelClientWrapper(process.env.REACT_APP_API_HOST);
